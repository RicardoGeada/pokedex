...
//#region LIST VIEW
        ...
        return /*html*/`
            <li id="pkmn-id-${number}" class="pkmn-list-item" onclick="openDetailView(${id})">
                <div class="pkmn-card ${types[0]}">
                    ...
                    <img class="pkmn-card-image" src="${image}" alt="${name}_img" onerror="this.src='./img/not-found.svg'">
    ...
    /**
     * scroll to bottom on pkmn list
     */
    function scrollToBottom() {
        let pkmnList = document.getElementById('pkmn-list');
        pkmnList.scrollTop = pkmnList.scrollHeight - pkmnList.offsetHeight - 20;
    }
    ...
    function toggleLoadMoreButton() {
        ...
        if (currentIndex + 1 <= searchPokemon.length) {
